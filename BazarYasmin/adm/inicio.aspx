<%@ Page Title="Inicio" Language="C#" MasterPageFile="~/adm.Master" AutoEventWireup="true" CodeBehind="inicio.aspx.cs" Inherits="BazarYasmin.adm.adm" %>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        Inicio <small>Resumen estadístico</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li class="active">
